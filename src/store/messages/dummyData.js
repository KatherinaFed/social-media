    ...
    },
    {
      ...
      chatMsg: [
        ...
        },
        {
          id: 5,
          userName: 'Lizzy K.',
          message: 'Hey! Today is a good and a sunny day! Because of your Birthday!! Happy Birthday my lovely dear! Love you!',
    ...
    },
    {
      ...
      chatMsg: [
        ...
        },
        {
          id: 2,
          userName: 'me',
          message: 'Hello Alex! Wow! What?!) It`s so cool) Glad for you. What kind of the job?',
          date: '05.MAR.2022, 19:33',
        },
        {
          id: 3,
          userName: 'Alex',
          message: 'Yeah, it`s really cool, I`m so glad) Now I`m a Senior Software Developer in Google =)',
      ...
      chatMsg: [
        {
          id: 1,
          userName: 'me',
          message: 'Hanna, do you want to walk after a lunch? I would like to smth discuss with you',
